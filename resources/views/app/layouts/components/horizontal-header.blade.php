						...
						<div class="d-flex">
						    <a class="header-brand" href="{{url('index')}}">
                                ...
                                <img src="{{URL::asset('assets/images/brand/logo1.png')}}" class="header-brand-img darklogo" alt="Olfat logo">
								<img src="{{URL::asset('assets/images/brand/icon.png')}}" class="header-brand-img icon-logo" alt="Olfat logo">
							</a><!-- logo-->
